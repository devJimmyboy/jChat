            ...
            case "PRIVMSG":
              ...
              if (!Chat.info.hideBadges) {
                if (
                  ...
                  Chat.info.chatterinoBadges &&
                  Chat.info.ffzapBadges &&
                  (!Chat.info.userBadges[nick] || !Chat.info.userPaints[nick])
                )
                  Chat.info.loadingBadges[nick] = new Promise((resolve, reject) =>
                    Chat.loadUserBadges(nick, message.tags["user-id"], resolve, reject)
                  )
              }
